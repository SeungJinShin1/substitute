    ...
    return (
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">보결 교시 선택</label>
          ...
          <button 
            ...
            className="w-full bg-indigo-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-indigo-700 flex items-center justify-center gap-2"
          >
            <Cpu size={20} />
            AI 보결 배정 요청하기
          </button>
